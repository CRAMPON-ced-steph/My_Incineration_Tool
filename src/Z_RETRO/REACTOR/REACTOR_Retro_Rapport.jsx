    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Réacteur — Rapport rétro-calcul</h2>
          <button onClick={onClose} style={styles.closeBtn}>✕ Fermer</button>
        </div>

        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>Rapport de synthèse — Mode rétro-calcul REACTOR</h1>
            ...
            <Section title="1. Paramètres d'entrée">
              <div style={styles.twoCol}>
                ...
                <SubSection title="Paramètres réactif">
                  {isCAP ? (
                    <>

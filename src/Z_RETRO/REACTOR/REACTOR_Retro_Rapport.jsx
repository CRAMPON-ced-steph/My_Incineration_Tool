...
const REACTOR_Retro_Rapport = ({ calculationResult, inputParams, onClose }) => {
  const df = calculationResult?.dataFlow || {};
  const dr = calculationResult?.dataREACTOR || {};
  const p  = inputParams || {};
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Réacteur (REACTOR) — Rapport rétro-calcul</h2>
        ...
        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>
              Rapport de synthèse — Mode rétro-calcul REACTOR
            </h1>
            ...
            {/* ── Section 4 : Réactifs et consommation ─────────────────────── */}
            <Section title="4. Réactifs et consommation">
              <div style={styles.twoCol}>
            ...
            <Section title="5. Synthèse">
              <div style={styles.tagRow}>
                {[
                  ...
                  { label: 'Conso CAP [kg/h]',        val: fmt(dr.conso_CAP_calcul_kg_h, 1),        color: '#8e44ad' },
...
export default REACTOR_Retro_Rapport;

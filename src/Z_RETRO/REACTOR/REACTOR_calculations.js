...
// performCalculation_REACTOR
export const performCalculation_REACTOR = (
    nodeData,
    T_amont_REACTOR,
    T_air,
    PDC_aero,
  ...
  const H_H2O_kj = (fh_H2O(T_amont_REACTOR) + 540 * 4.18) * Qm_H2O_kg_h;
  const H_O2_kj = fh_O2(T_amont_REACTOR) * Qm_O2_kg_h;
  const H_N2_kj = fh_N2(T_amont_REACTOR) * Qm_N2_kg_h;
  ...
  // ON CALCULE L'AIR DE TRANSPORT NECESSAIRE SELON LE REACTIF

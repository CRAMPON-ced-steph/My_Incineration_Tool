...
const QUENCH_Retro_Rapport = ({ calculationResult, inputParams, onClose }) => {
  const df = calculationResult?.dataFlow || {};
  const dq = calculationResult?.dataQUENCH || {};
  const p  = inputParams || {};
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Quench — Rapport rétro-calcul</h2>
        ...
        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>
              Rapport de synthèse — Mode rétro-calcul QUENCH
            </h1>
            ...
            <Section title="4. Bilan eau">
              <div style={styles.twoCol}>
                <SubSection title="Eau injectée">
                  <KV label="Eau injectée"     value={fmt(dq.Qeau, 0)}     unit="kg/h" />
                </SubSection>
            ...
            <Section title="5. Synthèse">
              <div style={styles.tagRow}>
                {[
                  ...
                  { label: 'Eau injectée [kg/h]',      val: fmt(dq.Qeau, 0),              color: '#8e44ad' },
...
export default QUENCH_Retro_Rapport;

...
const IACT_Retro_Rapport = ({ calculationResult, inputParams, onClose }) => {
  const df = calculationResult?.dataFlow || {};
  const di = calculationResult?.dataIACT || {};
  const p  = inputParams || {};
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Échangeur IACT — Rapport rétro-calcul</h2>
        ...
        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>
              Rapport de synthèse — Mode rétro-calcul IACT
            </h1>
            ...
            <Section title="1. Paramètres d'entrée">
              <div style={styles.twoCol}>
                <SubSection title="Conditions">
                  ...
                  <KV label="T air ambiant"           value={fmt(p.T_air_ambiant, 1)}         unit="°C" />
                  <KV label="T air chauffé"           value={fmt(p.T_air_chauffe, 1)}         unit="°C" />
                  <KV label="Rendement échange"       value={fmt(p.Rendement_echange, 1)}     unit="%" />
            ...
            <Section title="4. Échange thermique">
              <div style={styles.twoCol}>
                <SubSection title="Bilan côté fumées / air">
                  <KV label="ΔH fumées (chaleur cédée)"   value={fmt(di.Delta_H_FG, 0)}    unit="kJ/h" />
                  <KV label="ΔH air (chaleur reçue)"      value={fmt(di.Delta_H_air, 0)}   unit="kJ/h" />
                  <KV label="Débit massique air chauffé"  value={fmt(di.Qm_air_kg_h, 0)}   unit="kg/h" />
                  <KV label="Débit volumique air chauffé" value={fmt(di.Qv_air_Nm3_h, 0)}  unit="Nm³/h" />
                </SubSection>
            ...
            <Section title="5. Synthèse">
              <div style={styles.tagRow}>
                {[
                  ...
                  { label: 'ΔH fumées [kJ/h]',        val: fmt(di.Delta_H_FG, 0),      color: '#8e44ad' },
...
export default IACT_Retro_Rapport;

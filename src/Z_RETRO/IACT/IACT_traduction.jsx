export const translations = {
  fr: {
    ...
    Qair_decolmatation: "Débit air décolmatage",
  ...
  en: {
    ...
    Qair_decolmatation: "Dedusting Air Flow",
    Tair: "Air Temperature",
    T_fumees_amont: "Upstream Flue Gas Temperature",
    PDC_aero: "Aeraulic Pressure Drop",
  ...
  es: {
    ...
    Qair_decolmatation: "Caudal Aire Descolmatación",
    Tair: "Temperatura del Aire",
    T_fumees_amont: "Temperatura Gases Aguas Arriba",
    PDC_aero: "Caída de Presión Aeráulica",
  ...
  de: {
    ...
    Qair_decolmatation: "Abreinigungsluftmenge",
    Tair: "Lufttemperatur",
    T_fumees_amont: "Rauchgastemperatur Eingang",
    PDC_aero: "Aeraulischer Druckverlust",
  ...
  it: {
    ...
    Qair_decolmatation: "Portata Aria Pulizia",
    Tair: "Temperatura Aria",
    T_fumees_amont: "Temperatura Fumi a Monte",
    PDC_aero: "Perdita di Carico Aeraulica",
  ...
  ru: {
    ...
    Qair_decolmatation: "Расход воздуха регенерации",
  ...
  ar: {
    ...
    Qair_decolmatation: "تدفق هواء إزالة الانسداد",
    Tair: "درجة حرارة الهواء",
    T_fumees_amont: "درجة حرارة غازات المداخن المنبع",
    PDC_aero: "فقدان الضغط الهوائي",

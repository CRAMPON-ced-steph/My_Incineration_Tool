...
export const performCalculation_IACT = (nodeData, T_air_decolmatation, Q_air_decolmatation,T_amont_IACT, PDC_aero ) => {
...
let Qv_air_entrant_tot_Nm3_h = AIR_DILUTION_T(Tair, T_amont_IACT, T_aval_IACT,Qm_CO2_out_kg_h, Qm_H2O_out_kg_h, Qm_N2_out_kg_h, Qm_O2_out_kg_h);

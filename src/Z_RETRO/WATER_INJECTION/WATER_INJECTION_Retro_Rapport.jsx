...
const WATER_INJECTION_Retro_Rapport = ({ calculationResult, inputParams, onClose }) => {
  const r = calculationResult || {};
  const df = r.dataFlow || {};
  const dw = r.dataWATER_INJECTION || {};
  const p = inputParams || {};
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Injection d'eau (WATER_INJECTION) — Rapport rétro-calcul</h2>
          <button onClick={onClose} style={styles.closeBtn}>✕ Fermer</button>
        </div>

        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>Rapport de synthèse — Mode rétro-calcul WATER_INJECTION</h1>
            ...
            <Section title="4. Bilan eau">
              <div style={styles.twoCol}>
                <SubSection title="Eau injectée">
                  <KV label="Eau injectée" value={fmt(dw.Qeau, 0)} unit="kg/h" />
                </SubSection>
            ...
            <Section title="5. Synthèse">
              <div style={styles.tagRow}>
                {[
                  ...
                  { label: 'Eau injectée [kg/h]',       val: fmt(dw.Qeau, 0),           color: '#8e44ad' },
...
export default WATER_INJECTION_Retro_Rapport;

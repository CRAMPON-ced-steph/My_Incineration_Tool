...
// performCalculation_WATER_INJECTION_option_T
export const performCalculation_WATER_INJECTION_option_T = (nodeData, Tamont, Teau, PDC_aero) => {
...
// ON CALCULE LA REPARTITION POURCENT VOLUMIQUE
  ...
  const dataWATER_INJECTION = {Qeau,    PDC_aero,
    P_out_mmCE,}
  ...
  const dataFlow = {
    ...
    return {dataWATER_INJECTION , dataFlow}

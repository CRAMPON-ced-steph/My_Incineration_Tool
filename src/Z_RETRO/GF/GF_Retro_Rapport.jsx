...
const GF_Retro_Rapport = ({ calculationResult, nodeData, inputParams, onClose }) => {
      ...
      <div style={styles.modal}>
        ...
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>
            Four à grille — Rapport rétro-calcul
          </h2>
        ...
        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>
              Rapport de synthèse — Mode rétro-calcul GF
            </h1>
            ...
            <Section title="1. Paramètres d'entrée">
              <div style={styles.twoCol}>
                <SubSection title="Déchets et air">
                  ...
                  <KV label="Température air mesurée" value={fmt(p.Measured_air_temperature_C, 1)} unit="°C" />
            ...
            <Section title="2. Gaz de fumée — données de sortie procédé">
              <div style={styles.twoCol}>
                ...
                <SubSection title="Enthalpie">
                  ...
                  <KV label="Enthalpie air combustion" value={fmt(airComb.H_air_comb_kW, 0)} unit="kW" />
                </SubSection>
              </div>
              ...
              <div style={styles.twoCol}>
                <SubSection title="Bilan énergétique four">
                  <KV
                    ...
                    value={fmt((parseFloat(r.P_incinerateur_kWH) || 0) / 1000, 3)}
                    unit="MW"
                  />
                  <KV
                    label="Puissance thermique incinérateur"
                    value={fmt(r.P_incinerateur_kWH, 0)}
                    unit="kW"
                  />
                  <KV label="PCI déchet" value={fmt(r.PCI_kCal_kg, 0)} unit="kcal/kg" />
                  <KV label="PCI déchet" value={fmt(PCI_kJ_kg, 0)} unit="kJ/kg" />
                  <KV label="Pertes thermiques" value={fmt(pertes.H_pertes_thermiques_kW, 0)} unit="kW" />
                </SubSection>
                <SubSection title="Récupération chaleur">
                  ...
                  <KV label="H vapeur saturée" value={fmt(r.data_saturated_steam?.H_saturated_steam_kW, 0)} unit="kW" />
                  <KV label="H vapeur surchauffée" value={fmt(r.data_superheated_steam?.H_superheated_steam_kW, 0)} unit="kW" />
                </SubSection>
              </div>
            </Section>
            ...
            <Section title="4. Synthèse">
              <div style={styles.tagRow}>
                {[
                  {
                    label: 'Puissance [MW]',
                    val: fmt((parseFloat(r.P_incinerateur_kWH) || 0) / 1000, 3),
                    color: '#e74c3c',
                  },
                  {
                    label: 'PCI [kcal/kg]',
                    val: fmt(r.PCI_kCal_kg, 0),
                    color: '#f39c12',
                  },
                  {
                    label: 'Énergie récupérée [kW]',
                    val: fmt(INCI.Energie_recuperee_chaudiere_kW, 0),
                    color: '#4a90e2',
                  },
                  {
                    label: 'Rendement WHB [%]',
                    val: fmt(INCI.WHB_yield_pourcent, 1),
                    color: '#2ecc71',
                  },
                  {

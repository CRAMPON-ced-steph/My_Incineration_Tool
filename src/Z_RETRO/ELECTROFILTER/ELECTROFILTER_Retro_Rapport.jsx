...
const ELECTROFILTER_Retro_Rapport = ({ calculationResult, inputParams, onClose }) => {
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Électrofiltre — Rapport rétro-calcul</h2>
          <button onClick={onClose} style={styles.closeBtn}>✕ Fermer</button>
        </div>

        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>Rapport de synthèse — Mode rétro-calcul ELECTROFILTER</h1>
...
export default ELECTROFILTER_Retro_Rapport;

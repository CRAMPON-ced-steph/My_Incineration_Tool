...
const IDFAN_Retro_Rapport = ({ calculationResult, inputParams, onClose }) => {
  const df = calculationResult?.dataFlow || {};
  const di = calculationResult?.Id_fan || {};
  const p  = inputParams || {};
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Ventilateur ID (IDFAN) — Rapport rétro-calcul</h2>
        ...
        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>
              Rapport de synthèse — Mode rétro-calcul IDFAN
            </h1>
            ...
            <Section title="1. Paramètres d'entrée">
              <div style={styles.twoCol}>
                <SubSection title="Conditions">
                  ...
                  <KV label="PDC amont (P_amont)"   value={fmt(p.P_amont, 0)}         unit="mmCE" />
            ...
            <Section title="4. Ventilateur">
              <div style={styles.twoCol}>
                <SubSection title="Électrique">
                  <KV label="Puissance électrique"        value={fmt(di.P_elec, 1)}               unit="kW" />
                  <KV label="Chaleur dissipée (Pth)"      value={fmt(di.Pth_chaleur_dissipee, 1)}  unit="kW" />
                </SubSection>
                <SubSection title="Aérodynamique">
                  <KV label="Pression sortie (P_out)"     value={fmt(di.P_out_mmCE, 0)}           unit="mmCE" />
                  <KV label="Coefficient K (Nm³→m³)"      value={fmt(di.K, 4)}                    />
                </SubSection>
              </div>
            </Section>
            ...
            <Section title="5. Synthèse">
              <div style={styles.tagRow}>
                {[
                  ...
                  { label: 'P électrique [kW]',       val: fmt(di.P_elec, 1),          color: '#8e44ad' },
...
export default IDFAN_Retro_Rapport;

    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Tour de refroidissement — Rapport rétro-calcul</h2>
          <button onClick={onClose} style={styles.closeBtn}>✕ Fermer</button>
        </div>

        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>Rapport de synthèse — Mode rétro-calcul COOLING TOWER</h1>
            ...
            <Section title="1. Paramètres d'entrée">
              <div style={styles.twoCol}>
                ...
                <SubSection title="Débits injectés">
            ...
            <Section title="2. Bilan enthalpique">
              <div style={styles.twoCol}>
                <SubSection title="Enthalpie intermédiaire">
                  ...
                  <KV label="T intermédiaire calculée" value={fmt(d.T_intermediaire, 1)} unit="°C" />
                </SubSection>
                <SubSection title="Enthalpie vapeur">

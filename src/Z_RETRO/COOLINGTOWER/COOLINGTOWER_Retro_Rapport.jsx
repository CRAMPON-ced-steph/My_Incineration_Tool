...
const COOLINGTOWER_Retro_Rapport = ({ calculationResult, inputParams, onClose }) => {
  const r = calculationResult || {};
  const df = r.dataFlow || {};
  const dc = r.dataCOOLINGTOWER || {};
  const p = inputParams || {};
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        <div style={styles.header}>
          <h2 style={styles.headerTitle}>Tour de refroidissement (COOLINGTOWER) — Rapport rétro-calcul</h2>
          <button onClick={onClose} style={styles.closeBtn}>✕ Fermer</button>
        </div>

        <div style={styles.scrollArea}>
          <div style={styles.reportContent}>
            <h1 style={styles.mainTitle}>Rapport de synthèse — Mode rétro-calcul COOLINGTOWER</h1>
            ...
            <Section title="1. Paramètres d'entrée">
              <div style={styles.twoCol}>
                <SubSection title="Conditions">
                  ...
                  <KV label="T vapeur injectée" value={fmt(p.T_steam_C, 1)} unit="°C" />
            ...
            {/* Section 4 */}
            <Section title="4. Bilan thermique tour">
              <div style={styles.twoCol}>
                <SubSection title="Étape intermédiaire">
                  <KV label="T intermédiaire" value={fmt(dc.T_intermediaire, 1)} unit="°C" />
                  <KV label="H total intermédiaire" value={fmt(dc.H_tot_intermediaire_kW, 1)} unit="kW" />
                  <KV label="H total intermédiaire" value={fmt(dc.H_tot_intermediaire_kj, 0)} unit="kJ/h" />
                </SubSection>
                <SubSection title="Vapeur">
                  <KV label="T finale" value={fmt(dc.T_final, 1)} unit="°C" />
                  <KV label="H vapeur" value={fmt(dc.H_vapeur_kW, 1)} unit="kW" />
                  <KV label="H vapeur" value={fmt(dc.H_vapeur_kJ, 0)} unit="kJ/h" />
            ...
            <Section title="5. Synthèse">
              <div style={styles.tagRow}>
                {[
                  ...
                  { label: 'T intermédiaire [°C]',     val: fmt(dc.T_intermediaire, 1),      color: '#8e44ad' },
...
export default COOLINGTOWER_Retro_Rapport;

...
const DENOX_Report = ({ innerData = {} }) => {
  ...
  const reactifConsumption = [
    { label: 'NH₃ (Ammonia) [kg/h]', value: innerData.Conso_Ammonia_kg },
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.mainTitle}>DENOX — Rapport de synthèse</h1>

      <Section title="1. Gaz de combustion (sortie après réchauffage)">
        <div style={styles.twoCol}>
          <SubSection>
            <KV label="Température mélange calculée" value={fmt(T_OUT, 0)} unit="°C" />

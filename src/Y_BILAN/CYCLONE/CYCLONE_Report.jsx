    ...
    <div>
      ...
      <div style={styles.twoCol}>
        ...
        <div style={{ ...styles.subSection, background: '#f5f0ff', margin: 8, borderRadius: 6 }}>
          ...
          <KV label="CO₂ transport" value={fmt(co2TransportReactifs + co2TransportResidus, 3)} />
...
const CYCLONE_Report = ({ innerData = {} }) => {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.mainTitle}>Cyclone — Rapport de synthèse</h1>

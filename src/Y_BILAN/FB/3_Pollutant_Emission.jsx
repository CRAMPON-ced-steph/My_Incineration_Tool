...
const FBPollutantEmission = ({ innerData, setInnerData, currentLanguage = 'fr', nodeId }) => {
  ...
  useEffect(() => {
    localStorage.setItem(`emissions2_FB_${nodeId}`, JSON.stringify(emissions2));
  }, [emissions2]);
  ...
  const handleReset = useCallback(() => {
    ...
    try {
      localStorage.removeItem(`emissions2_FB_${nodeId}`);
    } catch (e) {

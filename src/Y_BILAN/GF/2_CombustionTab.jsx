...
function runIterativeCalc({
  ...
  for (let iter = 0; iter < MAX_ITER; iter++) {
    ...
    const H_MV = (PCI_OM_kcal_kgOM * BoueBrute_kg_h * cp_ref) / 3600;
    ...
    const Pertes = ((PCI_OM_kcal_kgOM * BoueBrute_kg_h * (Pertes_thermiques_pourcent / 100)) / 3600) * cp_ref;

...
const IACT_Report = ({ innerData = {} }) => {
  ...
  const FG_IACT_OUT_Nm3_h = innerData.FG_IACT_OUT_Nm3_h || innerData.FG_RK_OUT_Nm3_h || _nm3Computed;
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.mainTitle}>IACT — Rapport de synthèse</h1>
      ...
      <Section title="1. Gaz de combustion">
        <div style={styles.twoCol}>
          <SubSection>
            ...
            <KV label="Débit sec [Nm³/h]" value={fmt(FG_IACT_OUT_Nm3_h.dry, 0)} />
            <KV label="Débit humide [Nm³/h]" value={fmt(FG_IACT_OUT_Nm3_h.wet, 0)} />
          </SubSection>
          <SubSection title="Composition gaz de sortie">
            <GasTable data={{
              'kg/h': FG_OUT_kg_h,
              'Nm³/h': { CO2: FG_IACT_OUT_Nm3_h.CO2, H2O: FG_IACT_OUT_Nm3_h.H2O, O2: FG_IACT_OUT_Nm3_h.O2, N2: FG_IACT_OUT_Nm3_h.N2 },
            }} />
          </SubSection>
        </div>
      </Section>

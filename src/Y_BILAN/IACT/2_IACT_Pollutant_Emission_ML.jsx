...
const IACTFlueGasPollutantEmission = ({ innerData, currentLanguage = 'fr' }) => {
  const [emissionsIACT, setEmissions2] = useState(() => {
    const savedEmissions = localStorage.getItem('emissionsIACT');
  ...
  useEffect(() => {
    localStorage.setItem('emissionsIACT', JSON.stringify(emissionsIACT));
  }, [emissionsIACT]);

  // Extract values from emissionsIACT
  const FlyAsh_g_Nm3 = emissionsIACT['Fly ashes content [g/Nm3]'];
  const Bottom_Ash_Siccity = emissionsIACT['siccity bottom ash [%]'];
  const O2ref = emissionsIACT['O2 ref [%]'];

  const SOx_reactif = emissionsIACT['SOx reactif'];
  const HCl_reactif = emissionsIACT['HCl reactif'];
  const HF_reactif = emissionsIACT['HF reactif'];

  const efficacite_SOx = emissionsIACT['efficacite_SOx'];
  const HCl_efficacité = emissionsIACT['HCl efficacité'];
  const HF_efficacité = emissionsIACT['HF efficacité'];

  const SOx_stoechiométrie = emissionsIACT['SOx stoechiométrie'];
  const HCl_stoechiométrie = emissionsIACT['HCl stoechiométrie'];
  const HF_stoechiométrie = emissionsIACT['HF stoechiométrie'];
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem('emissionsIACT');
  };
        ...
        <table style={{
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{masses_pollutant_output.SO2.toFixed(3)}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{SOx_reactif !== 'None' ? mass_residus_SOx.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{SOx_reactif !== 'None' ? mass_reactif_reel_SOx.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{SOx_reactif !== 'None' ? mass_reduction_SOx.toFixed(3) : '0.000'}</td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HCl_reactif !== 'None' ? masses_pollutant_output.HCl.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '4px', textAlign: 'center', width: '11.11%' }}>
                <input
                  type="number"
              ...
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{masses_pollutant_output.HCl.toFixed(3)}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HCl_reactif !== 'None' ? mass_residus_HCl.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HCl_reactif !== 'None' ? mass_reactif_reel_HCl.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HCl_reactif !== 'None' ? mass_reduction_HCl.toFixed(3) : '0.000'}</td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HF_reactif !== 'None' ? masses_pollutant_output.HF.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '4px', textAlign: 'center', width: '11.11%' }}>
                <input
                  type="number"
                  value={HF_efficacité}
              ...
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{masses_pollutant_output.HF.toFixed(3)}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HF_reactif !== 'None' ? mass_residus_HF.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HF_reactif !== 'None' ? mass_reactif_reel_HF.toFixed(3) : '0.000'}</td>
              <td style={{ padding: '8px', textAlign: 'center', width: '11.11%' }}>{HF_reactif !== 'None' ? mass_reduction_HF.toFixed(3) : '0.000'}</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default IACTFlueGasPollutantEmission;

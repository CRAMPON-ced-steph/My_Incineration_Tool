...
const LinearGraph = () => {
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Waste Mass vs Furnace Power',
        font: {
          size: 16,
        }
      },
      tooltip: {
        callbacks: {
          label: function(context) {
            ...
            if (datasetLabel === 'Point E') {
              return `Point E: (${x} kg/h, ${y} MW)`;
            } else {
              const pointLabels = ['A', 'B', 'C', 'D', 'A'];
              const pointLabel = pointLabels[context.dataIndex];
              return `Point ${pointLabel}: (${x} kg/h, ${y} MW)`;
            }
          }
        }
      }
...
const isBelowThreshold = pointA.y < seuilB || pointD.y < seuilC;
  ...
  return (
    <div style={{
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Operating Domain Configuration</h2>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '20px', justifyContent: 'center' }}>
        ...
        <div style={{ border: '1px solid #ddd', padding: '10px', borderRadius: '5px', backgroundColor: 'rgba(255, 0, 0, 0.1)' }}>
          <h3 style={{ margin: '0 0 10px 0', color: 'red' }}>Point A</h3>
        ...
        <div style={{ border: '1px solid #ddd', padding: '10px', borderRadius: '5px', backgroundColor: 'rgba(0, 0, 255, 0.1)' }}>
          <h3 style={{ margin: '0 0 10px 0', color: 'blue' }}>Point B</h3>
          <div style={{ display: 'flex', gap: '10px' }}>
            <label>
              X (kg/h):
              <input
        ...
        <div style={{ border: '1px solid #ddd', padding: '10px', borderRadius: '5px', backgroundColor: 'rgba(0, 128, 0, 0.1)' }}>
          <h3 style={{ margin: '0 0 10px 0', color: 'green' }}>Point C</h3>
          <div style={{ display: 'flex', gap: '10px' }}>
            <label>
              X (kg/h):
              <input
        ...
        <div style={{ border: '1px solid #ddd', padding: '10px', borderRadius: '5px', backgroundColor: 'rgba(128, 0, 128, 0.1)' }}>
          <h3 style={{ margin: '0 0 10px 0', color: 'purple' }}>Point D</h3>
          <div style={{ display: 'flex', gap: '10px' }}>
            <label>
              X (kg/h):
              <input
        ...
        <div style={{ border: '1px solid #ddd', padding: '10px', borderRadius: '5px', backgroundColor: 'rgba(255, 165, 0, 0.1)' }}>
          <h3 style={{ margin: '0 0 10px 0', color: 'orange' }}>Point E</h3>
          <div style={{ display: 'flex', gap: '10px' }}>
            <label>
              X (kg/h):
              <input
  ...
  <div style={{
    ...
    ⚠️ La puissance minimum du four ne peut être inférieure à 40% de son maximum.
  </div>
)}
